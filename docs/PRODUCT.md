...
[Índice](README.md) · [Estado real](STATUS.md)
...
Estoque possui uma issue própria e permanece extensão posterior. Integração bancária, emissão fiscal, estornos, permissões de funcionários, reabertura controlada, backup automatizado e exportações não são entregas demonstradas do MVP atual.
...
Consulte [regras](BUSINESS_RULES.md), [Figma](FIGMA_STATUS.md) e [roadmap](../ROADMAP.md) para as decisões e lacunas, sem tratar uma tela desenhada como funcionalidade pronta.
