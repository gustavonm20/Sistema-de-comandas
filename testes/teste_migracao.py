...
class TestesMigracao(unittest.TestCase):
    def setUp(instancia):
        ...
        # Referência imutável: estrutura realmente publicada antes da tradução.
        estrutura = subprocess.check_output([
            "git", "show", "151b44a621ddda3198c00e65c90aee0b229f2d7f:database/schema.sql"
