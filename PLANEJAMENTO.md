...
| Verificação e acesso | Testes locais, integração MySQL e integração contínua aprovados | Concorrência, migrações, revisão Windows, política de lint e autenticação/CSRF | [#17](https://github.com/gustavonm20/Sistema-de-comandas/issues/17), [#24](https://github.com/gustavonm20/Sistema-de-comandas/issues/24) |
